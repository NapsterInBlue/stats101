Ideally, the [General Contribution Guide](https://git.rockfin.com/pages/DataScienceWiki/ContributionGuide/) covers a good chunk of what you'd want to include in a `CONTRIBUTING` message. Please feel free to reference it wherever you think it'd be useful.
...
[Here are some documents to help walk someone through their first pull request.](https://git.rockfin.com/pages/DataScienceWiki/ContributionGuide/firsttime.html)
